...
origen:     
    .byte 0x37             // Variable inicializada de 5 bytes
destino:    
    .space 1,0x00              // Variable de 20 bytes en blanco
...
reset:
    ...
    AND R4,R0,0xF0          //Cargo en R4 parte baja del BCD compactado
    LSR R4,#4               //Desplazo 4 bits a la izquierda 
    LDRB R4,[R3,R4]         // Cargar en R4 el elemento convertido
    STRB R4,[R2],#1         // Guardar el elemento convertido                        
